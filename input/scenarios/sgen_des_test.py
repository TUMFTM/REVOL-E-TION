...
data = {'bev_only': ['1/1/2005', '15T', 365, 25, 'go', 48, 24, 0.09, {'core': 'SystemCore',
                ...
                3.00E+04, None, 'cc', 'AC', 'bev_example', 5, 7, 2, 8, 2, 17, 2, 3.2, 0.88, 1.5, 0.5, 2, 1, 300, 25, 0.05, 1, 0, 0, 0, -0.0003, 0.00035, 10, 0.5, 11000, 11000, 1, 0.95, 0.95, 1,  # bev
                3.00E+03, 'cc', 'AC', 'brs_example', 5, 6, 1, 1.5, 0.5, 1, 0.12, 0.1, 1, 0, 0, 0, -0.0003, 0.00035, 10, 0.5, 1500, 1500, 1, 0.95, 0.95, 1],
        'brs_only': ['1/1/2005', '15T', 365, 25, 'go', 48, 24, 0.09, {'core': 'SystemCore',
                ...
                3.00E+04, 'AC', 15, 0, 0.00003, 10, 1, 1,  # grid
                1.10E+06, 'DC', 0.139, 0.142, 0.00417, 10, 1, 0.9, 0.9, 0.8, 0.8, 0.5, 0, 1, 1,  # ess
                3.00E+04, None, 'cc', 'AC', 'bev_example', 5, 7, 2, 8, 2, 17, 2, 3.2, 0.88, 1.5, 0.5, 2, 1, 300, 25,
                0.05, 1, 0, 0, 0, -0.0003, 0.00035, 10, 0.5, 11000, 11000, 1, 0.95, 0.95, 1,  # bev
                3.00E+03, 'cc', 'AC', 'brs_example', 5, 6, 1, 1.5, 0.5, 1, 0.12, 0.1, 1, 0, 0, 0, -0.0003, 0.00035, 10, 0.5,
                1500, 1500, 1, 0.95, 0.95, 1],
        'both': ['1/1/2005', '15T', 365, 25, 'go', 48, 24, 0.09, {'core': 'SystemCore',
                        ...
                        3.00E+04, 'AC', 15, 0, 0.00003, 10, 1, 1,  # grid
                        1.10E+06, 'DC', 0.139, 0.142, 0.00417, 10, 1, 0.9, 0.9, 0.8, 0.8, 0.5, 0, 1, 1,  # ess
                        3.00E+04, 'brs', 'cc', 'AC', 'bev_example', 5, 7, 2, 8, 2, 17, 2, 3.2, 0.88, 1.5, 0.5, 2, 1, 300, 25, 0.05, 1, 0, 0, 0, -0.0003, 0.00035, 10, 0.5, 11000, 11000, 1, 0.95, 0.95, 1,  # bev
                        3.00E+03, 'cc', 'AC', 'brs_usecases', 5, 6, 1, 1.5, 0.5, 1, 0.12, 0.1, 1, 0, 0, 0, -0.0003, 0.00035, 10, 0.5, 1500, 1500, 1, 0.95, 0.95, 1]
        }  # brs
