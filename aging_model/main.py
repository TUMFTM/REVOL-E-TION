...
for idx_p_profile, P_Value_Vehicle in enumerate(p_profile[0:60000]):
    SOC[idx_p_profile+1], Crate[idx_p_profile], P_Value_control, P_Cool[idx_p_profile], T_Cell[idx_p_profile+1], T_Housing[idx_p_profile+1] = calcElectroThermalValuesSingle(cell, bet,n_cells, T_Cell[idx_p_profile], SOC[idx_p_profile], Crate[idx_p_profile], P_Value_Vehicle, P_Cool[idx_p_profile-1], T_Housing[idx_p_profile], T_amb, dt)
